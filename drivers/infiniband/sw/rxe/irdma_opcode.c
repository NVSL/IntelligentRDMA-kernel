...
#define WITH_CHECK(expr) \
  ...
  /* UC */
  WITH_CHECK(register_opcode(IB_OPCODE_UC_SEND_FIRST, "IB_OPCODE_UC_SEND_FIRST",
      /*.irdma_op_num    = */ IRDMA_SEND,
      /*.qpt             = */ IB_QPT_UC,
      /*.immdt           = */ false,
      /*.payload         = */ true,
  ...
  /* UD */
  WITH_CHECK(register_opcode(IB_OPCODE_UD_SEND_ONLY, "IB_OPCODE_UD_SEND_ONLY",
      /*.irdma_op_num    = */ IRDMA_SEND,
      /*.qpt             = */ IB_QPT_UD,
      /*.immdt           = */ false,
      /*.payload         = */ true,
...
#if 0
  WITH_CHECK(register_opcode(IB_OPCODE_RD_SEND_FIRST, "IB_OPCODE_RD_SEND_FIRST",
      /*.irdma_op_num    = */ IRDMA_SEND,
      /*.qpt             = */ IB_QPT_RD,
      /*.immdt           = */ false,
      /*.payload         = */ true,
